                    ...
                    <div class="row no-margin padding-lg">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#tab-one" aria-controls="tab-one" role="tab" data-toggle="tab">Thursday</a>
                            </li>
                            <li role="presentation">
                                <a href="#tab-two" aria-controls="tab-two" role="tab" data-toggle="tab">Friday</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END Title -->
                ...
                <div class="container">
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="tab-one">
                            ...
                            <div class="col-md-12 padding-leftright-null">
                                <div class="text text-center padding-topbottom-null">
                                    <h2 class="margin-bottom-null left">Thursday</h2>
                                    <h3 class="margin-bottom-null left">24 May 2018</h3>
                                    <br>
                                ...
                                <div class="col-md-12 padding-leftright-null">
                                    <ul class="timeline">
                                        ...
                                        <li>
                                            ...
                                            <div class="title">
                                                <h3>2005</h3>
                                                <span>Reached 1 Million sales</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="content">
                                            ...
                                            <div class="title">
                                                <h3>2016</h3>
                                                <span>Best Agency of The Year</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab-two">
                            ...
                            <div class="col-md-12 padding-leftright-null">
                                <div class="text text-center padding-topbottom-null">
                                    <h2 class="margin-bottom-null left">Friday</h2>
                                    <h3 class="margin-bottom-null left">25 May 2018</h3>
                                    <br>
        ...
        <div class="container">
            <div class="row no-margin">
                ...
                <div class="col-md-3 text small">
                    ...
                    <p>Bussible Company
                        <br> 322 Moon St, Venice, 1231, Italy
                        <br> Mon. - Fri., 9 a.m. - 6.00 p.m.</p>
                </div>
                <div class="col-md-2 text small">
                    <h4 class="heading white margin-bottom-small weight-300">Main Links</h4>
                    <ul class="info">
                        <li>
                            <a href="index.html">Home</a>
                        </li>
        ...
        <div class="container">
            <div class="row no-margin">
                <div class="col-md-6 text">
                    <p>©2017
                        <a href="#">febe b.v.</a>. All rights reserved. </p>
                </div>
